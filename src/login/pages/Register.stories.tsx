            ...
            kcContext={{
                profile: {
                    attributesByName: {
                        favoritePet: {
                            name: "role",
                            displayName: "${profile.attributes.role}",
                            validators: {
                                options: {
                                    options: ["event-owner", "event-manager"]
                                }
                            },
                            annotations: {
                                inputOptionLabelsI18nPrefix: "profile.attributes.role.options"
                            },
                            required: false,
                            readOnly: false
                        } satisfies Attribute
                ...
                "x-keycloakify": {
                    messages: {
                        "profile.attributes.role": "Role",
                        "profile.attributes.role.options.event-owner": "Event Owner",
                        "profile.attributes.role.options.event-manager": "Event Manager",
                    }
                }
            }}
        />
